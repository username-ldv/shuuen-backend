...
type LibraryGroup struct {
	...
	Path        string         `gorm:"size:700;uniqueIndex;not null" json:"path"`
...
type Melody struct {
	...
	SourcePath  string        `gorm:"size:760;uniqueIndex;not null" json:"source_path"`
...
type FileVariant struct {
	...
	StoragePath  string `gorm:"size:760;uniqueIndex;not null" json:"storage_path"`
